...
<div class="container-fluid py-3 fixed-top" style="background-color: #ECE9E6">
  <div class="row">
    <div class="col-6">
	  ...
	  <div class="col-6">
          ...
          <td>
            <img src="img/contact/profile/<?php $data->profileImage(); ?>" class="img-fluid dropdown-toggle" id="dropdownMenuButton" ondragstart="return false;" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="max-height: 50px; cursor: pointer;">
              ...
              <a class="dropdown-item" href="your.php?action=cmdLogout">Logout</a>
            </div>
			  	</td>
		  	</tr>
		  </table>
...
<div class="container-fluid py-5">
  <div class="row">
    <div class="col-12 text-center">
      <?php $profile = new Session(); $profile->connect(); $profile->profileData(); $profile->disconnect(); ?>
    </div>
  </div>
</div>
